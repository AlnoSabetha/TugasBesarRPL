...
Route::get('/surat/dosen/hapustgs/{id}', 'SuratController@hapusTugas');
...
Route::get('/surat/dosen/hapusket/{id}', 'SuratController@hapusKeterangan');
...
Route::get('/surat/dosen/hapusba/{id}', 'SuratController@hapusBeritaAcara');
...
Route::get('/surat/dosen/hapussper/{id}', 'SuratController@hapusPermohonan');
