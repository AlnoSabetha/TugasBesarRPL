        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="width: 95rem;">
                    ...
                    <div class="card-body">
                        <form action="/surat/dosen/simpanba" method="POST">
                            @csrf
                            ...
                            <div class="col-md-5">
                                    <main class="form-signin">
                                        <form>
                                            ...
                                            <div class="form-floating mb-2">
                                            <input type="text" class="form-control btn-black" name="nama_acara" id="floatingInput">
                                            ...
                                            <div class="form-floating mb-3">
                                            <input type="text" class="form-control btn-black" name="nama_p_mitra" id="floatingInput">
