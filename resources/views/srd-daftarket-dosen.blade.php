                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>@if($s->status == 'sedang diproses')
                                        <a href="/surat/dosen/viewket/{{$s->id}}" class="btn btn-secondary"><img src="/img/view.png" alt="Print" width="20" height="20"></a>
                                    ...
                                    <a href="/surat/dosen/hapusket/{{$s->id}}" class="btn btn-danger"><img src="/img/deleteicon.png" alt="Hapus" width="20" height="20">
